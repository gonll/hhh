    ...
    <div id="modalMovimientosOperacion" class="modal-overlay" onclick="if(event.target===this) cerrarModalMovimientosOperacion()">
        <div class="modal-cobro" onclick="event.stopPropagation()" style="max-width:90%; max-height:90vh; overflow:auto; width:auto;">
            ...
            <div style="margin-bottom: 12px;">
                <button type="button" class="btn-guardar" onclick="togglePanelInformeMovOpIndex()">Informe</button>
                <div id="panelInformeAccionesMovOpIndex" style="display: none; margin-top: 10px; padding: 12px 14px; background: #f0f4f8; border-radius: 6px; border: 1px solid #c3d0e0;">
                    <div style="display: flex; flex-wrap: wrap; gap: 8px; align-items: center;">
                        <button type="button" class="btn-guardar" onclick="azucarImprimirInforme('wrapImpresionMovOp', azucarTituloModalMovOpIndex())" title="Imprimir">🖨️ Imprimir</button>
                        <button type="button" class="btn-guardar" onclick="azucarPdfInforme('wrapImpresionMovOp', azucarTituloModalMovOpIndex(), 'mov_pago_operacion')" title="Descargar PDF">📄 Descargar PDF</button>
                        <button type="button" class="btn-guardar" onclick="azucarWhatsappInforme('wrapImpresionMovOp', azucarTituloModalMovOpIndex(), 'mov_pago_operacion')" title="Enviar por WhatsApp (PDF)">Enviar</button>
                    </div>
                </div>
            </div>
            <div class="btns">
...
(function() {
    ...
    function togglePanelInformeMovOpIndex() {
        var p = document.getElementById('panelInformeAccionesMovOpIndex');
        if (!p) return;
    ...
    function abrirModalMovimientosOperacion(operacion) {
        ...
        var panelInf = document.getElementById('panelInformeAccionesMovOpIndex');
