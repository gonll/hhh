...
$incremento_meses = max(1, min(6, (int)($c['incremento_alquiler_meses'] ?? 2)));
$ipc_parts = contrato_texto_actualizacion_ipc($incremento_meses);
$ipc_indice = "índice ICL publicado por el Banco Central de la Republica Argentina y en caso de no existir por el indice de precios al consumidor, nivel general para la República Argentina, elaborado y publicado por el INDEC.";
$ipc_txt = $ipc_indice . ' ' . $ipc_parts['calculo'];
