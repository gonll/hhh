...
if (isset($_POST['id'])) {
    ...
    if ($usuario_id != ID_CAJA) {
        ...
        // No grabar en Caja si es SUELDO/EXTRAS o TRANSFERENCIA (para cualquier usuario) o si es Consorcio sin BOLETA/EFVO
        if (!$compro_es_sueldo && !$compro_es_transferencia && (!$es_consorcio || $compro_es_efvo_boleta)) {
